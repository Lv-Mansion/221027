// data.js (已更新为支持 SVG 和 PNG 混合模式)

// 图标库 (键值对形式，可以混合SVG代码和图片路径)
export const ICONS = {
    // --- SVG Icons (保留原始的SVG代码) ---
    ...
    // --- PNG Icons (使用图片路径) ---
    'github': 'icons/github.png',         // 假设您有一个 github.png 文件
    'cloudflare': 'icons/cloudflare.png', // 假设您有一个 cloudflare.png 文件
};

export const DEFAULT_ICON_NAME = 'link'; // 默认图标 (这是一个SVG图标)

// 初始链接数据 (注意 iconName 对应上面 ICONS 的键名)
export const initialLinks = [
    ...
    // ... 其他链接保持不变 ...
    { id: 'preset-9', title: 'GitHub (网站仓库)', url: 'https://github.com/Lv-Mansion/221027', desc: '本项目（导航网站）的源代码存放处，您可以访问此链接查看代码或fork。', categoryId: 'category-repo', iconName: 'github' }, // 这里使用了PNG图标
    { id: 'preset-10', title: 'Cloudflare', url: 'https://dash.cloudflare.com/', desc: '全球领先的CDN与安全服务商，为网站提供加速、DDoS防护和DNS解析服务。', categoryId: 'category-study', iconName: 'cloudflare' } // 这里也使用了PNG图标
];
