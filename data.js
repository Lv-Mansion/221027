// ↓↓↓ 在这里添加版本号 ↓↓↓
export const DATA_VERSION = 'V1.1.1'; // 您可以随便设置，比如 '1.1' 或 2
...
export const initialLinks = [
    ...
    { id: 'preset-10', title: 'Cloudflare', url: 'https://dash.cloudflare.com/', desc: '全球领先的CDN与安全服务商，为网站提供加速、DDoS防护和DNS解析服务。', categoryId: 'category-study', iconName: 'cloudflare' }
];
